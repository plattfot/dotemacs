        ...
        (setf elfeed-feeds
              `(("https://rebusinla.wordpress.com/feed/" fun blog)
                ...
                ,@(plt/elfeed-youtube-feeds
                   '(("Avatar" "UCyaPf0E-PRRZH3UvvxNPeEw" youtube music)
                     ("Blackbriar" "UCjR-qXRBNkysQ0Threo1Bfg" youtube music)
                     ("Cppcon" "UCMlGfpWw-RUdWX_JbLCukXg" youtube talks)
                     ("Fosdem" "UC9NuJImUbaSNKiwF2bdSfAw" youtube talks)
                     ("Gamers Nexus" "UChIs72whgZI9w6d6FhwGGHA" youtube news nerd)
                     ("Ghost" "UCAOiVaJJlH0Oduv48NN0mMA" youtube music)
                     ("HackersOnBoard" "UChGDEluRG9r5kCecRAQTx_Q" youtube talks)
                     ("Infidelamsterdam" "UCTp0MnlTlmqC3NdrPzD08EA" youtube news vlog)
                     ("Intermit.Tech" "UCv7UOhZ2XuPwm9SN5oJsCjA" youtube news vlog)
                     ("Knyght Errant" "UC1T4KJG1L_kTrP9RcdU5Csw" youtube history)
                     ("Level1Linux" "UCOWcZ6Wicl-1N34H0zZe38w" youtube linux)
                     ("Level1Techs" "UC4w1YQAJMWOz4qtxinq55LQ" youtube nerd)
                     ("Lindybeige" "UC9pgQfOXRsp4UKrI8q0zjXQ" youtube history)
                     ("Mark Furneaux" "UCRDQEDxAVuxcsyeEoOpSoRA" youtube nerd)
                     ("Matgeek" "UCSGHj0YjencmGUSksbMbBVQ" youtube food)
                     ("Orbit Culture" "UC2XMr58U7rZnL4AW0n9Ca8g" youtube music)
                     ("Paul's Hardware" "UCvWWf-LYjaujE50iYai8WgQ" youtube news nerd)
                     ("Sabaton" "UCjQhd1APsd5NQhiVZV7GYzg" youtube music)
                     ("Sabaton History" "UCaG4CBbZih6nLzD08bTBGfw" youtube history)
                     ("Skallagrim" "UC3WIohkLkH4GFoMrrWVZZFA" youtube history)
                     ("Sweclockers" "UCW64r1wPzfj0W1qbzzfCgFg" youtube news nerd)
                     ("Sweclockers Extra" "UCfK96bDQdSkKFAdqNv0YOmw" youtube nerd fun)
                     ("The Hu" "UCs6vRDdkZ8bP8Xt6WHbvrwA" youtube music)
                     ("Nuclear Blast Records" "UCoxg3Kml41wE3IPq-PC-LQw" youtube music)
                     ("Century Media Records" "UCnK9PxMozTYs8ELOvgMNKFA" youtube music)
                     ))
                )))
    #+end_src
