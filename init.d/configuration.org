...
*** Org
    ...
    *NOTE* Work in progress. Only support repeating todos
...
*** elfeed
    #+begin_src emacs-lisp
      ...
      (cl-defun plt/elfeed-group-feeds (&key tags feeds)
    ...
    #+begin_src emacs-lisp
      (use-package elfeed
        ...
        (let ((time "@6-months-ago"))
          (plt/make-elfeed-set-filter unread (format "%s +unread -podcast" time))
        ...
        (add-hook 'elfeed-new-entry-hook
                  (elfeed-make-tagger :before "1 week ago"
                                      :remove 'unread))
        (setf elfeed-search-filter "@6-months-ago +unread -podcast"
              elfeed-feeds
              `(,@(plt/elfeed-group-feeds
                ...
                ,@(plt/elfeed-youtube-feeds
                   '(("Avatar" "UCyaPf0E-PRRZH3UvvxNPeEw" music)
                     ...
                     ("Level1Linux" "UCOWcZ6Wicl-1N34H0zZe38w" nerd linux)
                     ...
                     ("Linux for Everyone" "UCd4XwUn2Lure2NHHjukoCwA" linux)
