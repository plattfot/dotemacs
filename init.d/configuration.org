...
nosier than what I get from ~eglot~.
  ...
  (setup meow
    ...
    (transient-define-prefix plt/meow-window-popup ()
      ...
      ["Window"
       ...
       ("o" "Other" plt/meow-other-window-popup)
       ("b" "Split below" split-window-below)
       ("r" "Split right" split-window-right)
       ])
    (transient-define-prefix plt/meow-other-window-popup ()
      "Prefix for handling other windows."
      ["Other window(s)"
       ("d" "Delete" delete-other-windows)
       ("s" "Switch" other-window)
       ])
    (transient-define-prefix plt/meow-frame-popup ()
      "Prefix for handling frames."
      ["Frame"
       ("d" "Delete" delete-frame)
       ("m" "Make" make-frame)
       ("o" "Other" plt/meow-other-frame-popup)
       ])
    (transient-define-prefix plt/meow-other-frame-popup ()
      "Prefix for handling other frames."
      ["Other frame(s)"
       ("d" "Delete" delete-other-frames)
