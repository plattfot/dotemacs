...
;;    (quote
;;     (use-package esup yasnippet yaml-mode sudo-edit string-inflection rtags org-bullets multi-term move-text mc-extras magit ledger-mode go-autocomplete gnuplot flycheck expand-region evil-numbers buffer-move ag))))
;; (custom-set-faces
