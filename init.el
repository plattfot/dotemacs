...
;;    (quote
;;     (org-bullets yasnippet yaml-mode white-sand-theme use-package sudo-edit string-inflection rtags multi-term move-text mc-extras magit ledger-mode go-autocomplete gnuplot flycheck expand-region evil-numbers company cmake-mode buffer-move ag))))
